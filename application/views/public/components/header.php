  ...
  <header id="header">
    <div class="container">
      <div class="row align-items-center justify-content-between d-flex">
        <div id="logo" style="background-color: white ; padding:3px">
          <a href="<?php echo base_url("/home"); ?>" style="color:#FFF">
            <img id="logo" width="152" , height="40" title="<?php echo $system_global_settings->system_title; ?> Logo" src="<?php echo base_url("assets/uploads/" . $system_global_settings->sytem_public_logo); ?>" />
        </div>
        <nav id="nav-menu-container">
          <ul class="nav-menu">
            ...
            <li><a style="color:black !important" href="<?php echo base_url(); ?>">
                <i style="color:black !important" class="fa fa-home fa-lg"></i> Home</a></li>
            <li><a href="<?php echo base_url("/services"); ?>">Intervention in Target Areas</a></li>
