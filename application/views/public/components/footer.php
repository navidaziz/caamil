	...
	<div class="container">
		<div class="row">
			...
			<div class="ol-lg-6 col-md-6 single-footer-widget" data-wow-delay="0.3s" style="color: rgb(255, 201, 10) !important">
				<h4 id="log_title" style="color: rgb(255, 201, 10);"><?php echo $system_global_settings->system_title; ?></h4>
				<?php echo $system_global_settings->system_sub_title; ?>
				<!--<a href="<?php echo base_url("/movers"); ?>"><img title="<?php echo $system_global_settings->system_title; ?> Logo" src="<?php echo base_url("assets/uploads/" . $system_global_settings->sytem_public_logo); ?>" style="height:50px;" /></a>-->
				<p><?php echo substr($system_global_settings->description, 0, "600"); ?> ... <a href="<?php site_url("about_us"); ?>" style="color:#F00"><em>Read More...</em></a></p>
			...
			<div class="col-lg-4 col-md-6 single-footer-widget" data-wow-delay="0.3s">
				...
				<div class="contact-info" style="color:#FFF">
					...
					<span> <i class="fa fa-phone"></i> <?php //echo $system_global_settings->phone_number; 
														?> , <?php echo $system_global_settings->mobile_number; ?></span> <br> <span><i class="fa fa-fax"></i> <?php echo $system_global_settings->fax_number; ?></span> <br>
				</div>
			...
			<div style="text-align:center !important; width:100%; margin-top:10px !important; color:#FFF"> <?php echo date("Y", time()); ?>
				&copy; <strong><?php echo $system_global_settings->system_title; ?></strong>
			</div>
		</div>
