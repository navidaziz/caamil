            ...
            <div id="logo">
              ...
              <p style="text-align: center;">
                <a href="<?php echo site_url(); ?>">
                  <i class="fa fa-home" aria-hidden="true"></i> Back to webiste
                </a>
              </p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="login-box" style="background-color:#272727;  margin: 5px auto; padding-top:10px !important; padding: 55px 40px 40px;">
