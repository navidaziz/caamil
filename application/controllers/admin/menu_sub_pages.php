...
class Menu_sub_pages extends Admin_Controller
{
    ...
    public function add()
    {
        ...
        $this->data["title"] = $this->lang->line('Add New Menu Sub Page');
        $this->data["view"] = ADMIN_DIR . "menu_sub_pages/add_menu_sub_page";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
    ...
    public function edit($menu_sub_page_id)
    {
        ...
        $this->data["title"] = $this->lang->line('Edit Menu Sub Page');
        $this->data["view"] = ADMIN_DIR . "menu_sub_pages/edit_menu_sub_page";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
