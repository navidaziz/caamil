...
class Gallery extends Admin_Controller
{
    ...
    public function add()
    {
        ...
        $this->data["title"] = $this->lang->line('Add New Gallery');
        $this->data["view"] = ADMIN_DIR . "gallery/add_gallery";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
    ...
    public function edit($gallery_id)
    {
        ...
        $this->data["title"] = $this->lang->line('Edit Gallery');
        $this->data["view"] = ADMIN_DIR . "gallery/edit_gallery";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
