...
class Services extends Admin_Controller
{
    ...
    public function add()
    {
        ...
        $this->data["title"] = $this->lang->line('Add New Service');
        $this->data["view"] = ADMIN_DIR . "services/add_service";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
    ...
    public function edit($service_id)
    {
        ...
        $this->data["title"] = $this->lang->line('Edit Service');
        $this->data["view"] = ADMIN_DIR . "services/edit_service";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
