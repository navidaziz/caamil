...
class Page_contents extends Admin_Controller
{
    ...
    public function add()
    {
        ...
        $this->data["title"] = $this->lang->line('Add New Page Content');
        $this->data["view"] = ADMIN_DIR . "page_contents/add_page_content";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
    ...
    public function edit($page_content_id)
    {
        ...
        $this->data["title"] = $this->lang->line('Edit Page Content');
        $this->data["view"] = ADMIN_DIR . "page_contents/edit_page_content";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
