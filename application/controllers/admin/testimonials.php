...
class Testimonials extends Admin_Controller
{
    ...
    public function add()
    {
        ...
        $this->data["title"] = $this->lang->line('Add New Testimonial');
        $this->data["view"] = ADMIN_DIR . "testimonials/add_testimonial";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
    ...
    public function edit($testimonial_id)
    {
        ...
        $this->data["title"] = $this->lang->line('Edit Testimonial');
        $this->data["view"] = ADMIN_DIR . "testimonials/edit_testimonial";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
