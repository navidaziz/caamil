...
class Social_media_icons extends Admin_Controller
{
    ...
    public function add()
    {
        ...
        $this->data["title"] = $this->lang->line('Add New Social Media Icon');
        $this->data["view"] = ADMIN_DIR . "social_media_icons/add_social_media_icon";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
    ...
    public function edit($social_media_icon_id)
    {
        ...
        $this->data["title"] = $this->lang->line('Edit Social Media Icon');
        $this->data["view"] = ADMIN_DIR . "social_media_icons/edit_social_media_icon";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
