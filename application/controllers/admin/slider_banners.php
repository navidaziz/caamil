...
class Slider_banners extends Admin_Controller
{
    ...
    public function add()
    {
        ...
        $this->data["title"] = $this->lang->line('Add New Slider Banner');
        $this->data["view"] = ADMIN_DIR . "slider_banners/add_slider_banner";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
    ...
    public function edit($slider_banner_id)
    {
        ...
        $this->data["title"] = $this->lang->line('Edit Slider Banner');
        $this->data["view"] = ADMIN_DIR . "slider_banners/edit_slider_banner";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
