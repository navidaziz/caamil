...
class Menu_pages extends Admin_Controller
{
    ...
    public function add()
    {
        ...
        $this->data["title"] = $this->lang->line('Add New Menu Page');
        $this->data["view"] = ADMIN_DIR . "menu_pages/add_menu_page";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
    ...
    public function edit($menu_page_id)
    {
        ...
        $this->data["title"] = $this->lang->line('Edit Menu Page');
        $this->data["view"] = ADMIN_DIR . "menu_pages/edit_menu_page";
        $this->load->view(ADMIN_DIR . "layout", $this->data);
    }
    //--------------------------------------------------------------------
